...
- Name: .claude\worktrees\wonderful-joliot-beffdd\apps\web\tests\e2e\auth.spec.ts >> Authentication >> should show error on mismatched passwords
- Location: .claude\worktrees\wonderful-joliot-beffdd\apps\web\tests\e2e\auth.spec.ts:24:7
...
> 25 |     await page.goto('/signup');
  ...
  30 |     await page.locator('input[id="confirmPassword"]').press('Enter');
  31 |     
