...
- Name: .claude\worktrees\cranky-lewin-bd1f99\apps\web\tests\e2e\auth.spec.ts >> Authentication >> should show error on mismatched passwords
- Location: .claude\worktrees\cranky-lewin-bd1f99\apps\web\tests\e2e\auth.spec.ts:24:7
