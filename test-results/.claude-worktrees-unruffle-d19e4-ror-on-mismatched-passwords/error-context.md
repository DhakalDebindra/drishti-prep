...
- Name: .claude\worktrees\unruffled-jones-45c9d2\apps\web\tests\e2e\auth.spec.ts >> Authentication >> should show error on mismatched passwords
- Location: .claude\worktrees\unruffled-jones-45c9d2\apps\web\tests\e2e\auth.spec.ts:24:7
