      ...
      {options.map((option, index) => {
        ...
        return (
          <button
            ...
            className={`w-full relative group rounded-2xl p-5 sm:p-6 text-left transition-all duration-200 focus:outline-none focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-[#39FF14] forced-colors:focus-visible:outline-[Highlight] ${
              isSelected && selectedAnswer?.is_correct === true
                ? "border-[4px] border-b-[8px] border-[#39FF14] bg-emerald-600 text-[#39FF14] shadow-[4px_4px_0px_0px_rgba(57,255,20,1)]"
                : isSelected && selectedAnswer?.is_correct === false
                ? "border-[4px] border-b-[8px] border-red-600 bg-red-950 text-[#39FF14] shadow-[4px_4px_0px_0px_rgba(220,38,38,1)]"
                : isCorrectOption && selectedAnswer
                ? "border-[4px] border-b-[8px] border-[#39FF14] bg-emerald-600 text-[#39FF14] shadow-[4px_4px_0px_0px_rgba(57,255,20,1)]"
                : isSelected
                ? "border-[4px] border-b-[8px] border-[#39FF14] bg-[#39FF14] text-black shadow-[4px_4px_0px_0px_rgba(57,255,20,1)]"
                : "border-[4px] border-b-[8px] active:translate-y-[4px] active:border-b-[4px] border-[#39FF14] hover:bg-[#39FF14]/20 text-[#39FF14] hover:text-[#39FF14]"
          ...
          >
            <div className="flex items-start gap-4 sm:gap-6">
              ...
              <div aria-hidden="true" className={`shrink-0 flex items-center justify-center w-12 h-12 rounded-xl border-[3px] border-[#39FF14] text-xl font-black transition-colors ${
                isSelected && selectedAnswer?.is_correct === true ? "bg-[#39FF14] text-black" :
                isSelected && selectedAnswer?.is_correct === false ? "bg-red-600 text-black border-red-600" :
                isCorrectOption && selectedAnswer ? "bg-[#39FF14] text-black" :
                isSelected ? "bg-black text-[#39FF14]" :
                "bg-black text-[#39FF14] group-hover:bg-[#39FF14] group-hover:text-black"
              }`}>
                {option.value}
              </div>
              ...
              <div className="space-y-3 flex-1 pt-1">
                <p id={optionLabelId} className={`text-lg sm:text-xl md:text-2xl font-black leading-snug transition-colors ${
                  isSelected || (isCorrectOption && selectedAnswer) ? "text-black" : "text-[#39FF14]"
                }`}>
