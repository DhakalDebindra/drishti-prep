...
function PracticeSetView() {
  ...
  return (
    <main className="fixed inset-0 z-[100] overflow-y-auto bg-[#0a192f] font-sans text-white selection:bg-white selection:text-[#0a192f]">
      <div className="max-w-4xl mx-auto min-h-screen flex flex-col p-4 sm:p-6 md:p-8 gap-6 pb-40 md:pb-12">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between bg-[#112240] px-6 py-5 rounded-2xl shadow-xl border border-[#233554] gap-4">
          <div className="space-y-1.5">
            <h1 id="main-heading" className="text-xl sm:text-2xl font-black text-white tracking-tight">
              {setInfo.title}
            </h1>
            <nav aria-label="Breadcrumb">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm font-bold text-slate-300">
      ...
      <div className={`practice-experience-container flex flex-col bg-[#112240] rounded-3xl shadow-2xl border border-[#233554] overflow-hidden ${state.status === "submitted" ? "opacity-90" : ""}`}>
        {/* Prominent Progress Ribbon */}
        <div className="bg-[#0a192f]/50 border-b border-[#233554] px-6 sm:px-10 py-5 sm:py-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              <span className="text-[11px] font-black tracking-widest uppercase text-slate-400 mb-1">
                Question {currentIndex + 1} of {questionCount}
              </span>
          ...
          <div className="flex items-center gap-4 text-sm font-black text-white">
            <div className="w-24 sm:w-40 h-3 bg-[#0a192f] rounded-full overflow-hidden border border-[#233554]">
              <div 
      ...
      <div
        className="md:hidden fixed inset-x-4 bottom-6 z-[110] bg-[#112240]/95 backdrop-blur-xl shadow-2xl rounded-3xl border border-[#233554] p-2 transition-transform duration-300"
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <Button
            aria-label="Previous question"
            variant="ghost"
            className="flex-1 h-14 bg-[#0a192f] text-white hover:bg-[#233554] font-black focus-visible:ring-4 focus-visible:ring-slate-400 gap-1 rounded-2xl"
            onClick={goPrev}
            disabled={currentIndex === 0}
          >
            <ChevronLeft aria-hidden="true" strokeWidth={3} />
