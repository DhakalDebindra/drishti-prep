...
function PracticeSetView() {
  ...
  return (
    <main className="fixed inset-0 z-[100] overflow-y-auto bg-[#120224] font-sans text-white selection:bg-white selection:text-[#120224]">
      <div className="max-w-4xl mx-auto min-h-screen flex flex-col p-4 sm:p-6 md:p-8 gap-6 pb-40 md:pb-12">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between bg-[#250847] px-6 py-5 rounded-2xl shadow-xl border border-[#3e1272] gap-4">
          <div className="space-y-1.5">
            <h1 id="main-heading" className="text-xl sm:text-2xl font-black text-white tracking-tight">
              {setInfo.title}
            </h1>
            <nav aria-label="Breadcrumb">
              <ol className="flex flex-wrap items-center gap-2 text-xs sm:text-sm font-bold text-violet-300">
                <li className="uppercase tracking-widest"><Lang>{setInfo.subjectName}</Lang></li>
                <li aria-hidden="true" className="text-violet-500/50">•</li>
                <li className="uppercase tracking-widest font-black text-white"><Lang>{setInfo.topicName}</Lang></li>
              </ol>
            </nav>
          </div>
      ...
      <div className={`practice-experience-container flex flex-col bg-[#250847] rounded-3xl shadow-2xl border border-[#3e1272] overflow-hidden ${state.status === "submitted" ? "opacity-90" : ""}`}>
        {/* Prominent Progress Ribbon */}
        <div className="bg-[#120224]/50 border-b border-[#3e1272] px-6 sm:px-10 py-5 sm:py-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex flex-col">
              <span className="text-[11px] font-black tracking-widest uppercase text-violet-300 mb-1">
                Question {currentIndex + 1} of {questionCount}
              </span>
          ...
          <div className="flex items-center gap-4 text-sm font-black text-white">
            <div className="w-24 sm:w-40 h-3 bg-[#120224] rounded-full overflow-hidden border border-[#3e1272]">
              <div 
      ...
      <div
        className="md:hidden fixed inset-x-4 bottom-6 z-[110] bg-[#250847]/95 backdrop-blur-xl shadow-2xl rounded-3xl border border-[#3e1272] p-2 transition-transform duration-300"
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <Button
            aria-label="Previous question"
            variant="ghost"
            className="flex-1 h-14 bg-[#120224] text-white hover:bg-[#3e1272] font-black border border-[#3e1272] focus-visible:ring-4 focus-visible:ring-violet-400 gap-1 rounded-2xl transition-colors"
            onClick={goPrev}
            disabled={currentIndex === 0}
          >
            <ChevronLeft aria-hidden="true" strokeWidth={3} />
