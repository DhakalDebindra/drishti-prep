...
export default async function NestedReviewPage({ params, searchParams }: PageProps) {
  ...
  if (attempt.status !== "submitted") {
    const { moduleSlug, subjectSlug, topicSlug, setId } = await params;
    redirect(`/courses/${moduleSlug}/${subjectSlug}/${topicSlug}/practice/${setId}`);
  }
